...
public class EmployeeController {
  ...
  // public List<Employee> findByDepartment(@PathVariable("department") String
  // department) {
  //
  // List<Employee> employeeSortingName =
  ...
  // Specification.where(EmployeeSpecification.hasFirstName(name)
